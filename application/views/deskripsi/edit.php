  ...
  <div class="box">
    ...
    <div class="box-body">
      ...
      $atribut_form = array(
        ...
        echo form_open('deskripsi/update/'.$siswa[0]->nis, $atribut_form);
      ?>
      <div class="col-md-12">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <div class="col-sm-9">
              ...
              <input type="hidden" name="idcat" value="<?= $catatan[0]->id_catatan ?>">
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-3 control-label">Catatan Akademik</label> <div class="col-sm-9">
              <textarea name="catatan_akademik" id="" cols="30" rows="5" class="form-control" placeholder="Masukkan catatan akademik disini...."><?= $catatan[0]->catatan_akademik ?></textarea>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-3 control-label">Catatan Karakter</label> <div class="col-sm-9">
              <textarea name="catatan_karakter" id="" cols="30" rows="5" class="form-control" placeholder="Masukkan catatan pengembangan karakter disini...."><?= $catatan[0]->catatan_karakter ?></textarea>
            </div>
          </div>
