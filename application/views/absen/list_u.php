...
<section class="content">
  ...
  <div class="box">
    <div class="box-header with-border">
      <h3 class="box-title">Update absen</h3>
    ...
    <div class="box-body">
      ...
      $atribut_form = array(
        ...
        echo form_open('absen/update/'.$id_kelas, $atribut_form);
      ?>
      <table id="mytable" class="table table-striped table-bordered table-hover table-full-width dataTable" cellspacing="0" width="100%">
        ...
        <?php $no = 1; foreach($siswa as $s): ?>
            <tr>
                ...
                <td><?= $s->nama_siswa ?></td>
                <td>
                    <input type="text" name="sakit[]" value="<?= $s->sakit ?>" class="form-control w-40">
                </td>
                <td>
                    <input type="text" name="izin[]" value="<?= $s->izin ?>" class="form-control w-40">
                </td>
                <td>
                    <input type="text" name="alpa[]" value="<?= $s->tk ?>" class="form-control w-40">
                </td>
            </tr>
