  ...
  <div class="box">
    <div class="box-header with-border">
      ...
      <div class="box-tools pull-right">
        <?= anchor('guru/add', '<i class="fa fa-plus-square"></i>', 'class="btn btn-box-tool" data-toggle="tooltip" title="Tambah Data"'); ?>
        <?= anchor('guru/upl', '<i class="fa fa-upload"></i>', 'class="btn btn-box-tool" data-toggle="tooltip" title="Uploads Data"'); ?>
