  ...
  <div class="box">
    ...
    <div class="box-body">
        ...
        $atribut_form = array(
            ...
            echo form_open('pkl/add', $atribut_form);
        ?>
        <table id="mytable" class="table table-striped table-bordered table-hover table-full-width dataTable" cellspacing="0" width="100%">
            ...
            <?php $no = 1; foreach($siswa as $s): ?>
                <tr>
                    ...
                    <td>
                        <input type="text" name="dudi[]" class="form-control" placeholder="Nama DU/DI">
                    </td>
                    <td>
                        <input type="text" name="lokasi[]" class="form-control" placeholder="Lokasi">
                    </td>
                    <td>
                        <input type="text" name="lama[]" class="form-control" placeholder="Lama">
                    </td>
                    <td>
