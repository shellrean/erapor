      ...
      <div class="col-md-12">
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control" name="nisn" placeholder="Nomor Induk Siswa Nasional" value="<?= $nisn; ?>">
            </div>
          </div> 
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-4 date">
              <input type="text" class="form-control" name="tgl_lahir" placeholder="Tanggal Lahir Siswa" value="<?php echo $tgl_lahir; ?>">
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control"  name="tgl_diterima" placeholder="Tanggal diterima" value="<?php echo $tgl_diterima; ?>">
            </div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control" name="kelas_diterima" placeholder="Diterima di kelas?" min="1" value="<?php echo $kelas_diterima; ?>">
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control" name="telp_ortu" placeholder="Telp orang tua" value="<?= $telp_ortu; ?>">
            </div>
          </div>
          <div class="form-group">
